   ...
   // 3. flight cancelled
   // 4. count spaces and take away from guesses
   ...
   function chooseRandomCity() {
       ...
       console.log("placeholder: " + placeholderChars.join(""));
   }
   ...
   function checkGuess(letter) {
       ...
       if (guessedLetters.includes(letter)) {
           ...
           for (var i = 0; i < capitalCityChars.length; i++) {
               ...
               if (capitalCityChars[i] == " ") { //check for space character and display it after first guess
                  writeLetter(i, " ");
               }
